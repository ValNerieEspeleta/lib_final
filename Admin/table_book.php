...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit_id'])) {
    ...
    $updateBook = "UPDATE lib_books SET title='$title', description='$description', status='$status', genre_id=$genre_id WHERE book_id='$editBookId'";
                        ...
                        <?php if ($bookResult && mysqli_num_rows($bookResult) > 0): ?>
                          <?php while ($row = mysqli_fetch_assoc($bookResult)): ?>
                            <tr>
                              ...
                              <td><strong><?php echo htmlspecialchars(shortenText($row['title'], 8)); ?></strong></td>
