        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <?php
              ...
              if (!isset($_SESSION['profile_pic']) && isset($_SESSION['userId'])) {
              ...
              $nav_profile_pic = "static/images/admin.png"; // Default for SuperAdmin folder

              if (!empty($profilePic)) {
                  // Try different possible paths relative to SuperAdmin/ folder
                  $possiblePaths = [
                  ...
                  foreach ($possiblePaths as $testPath) {
                      if (file_exists($testPath)) {
                          $nav_profile_pic = $testPath;
                          break;
                      }
                  }
              }
            ?>
            <a class="nav-link dropdown-toggle d-flex align-items-center" href="javascript:void(0)" id="profileDropdown" style="cursor: pointer; padding: 0;">
              <span class="mr-3 d-none d-lg-inline text-dark font-weight-bold" style="font-size: 1.1rem;"><?php echo htmlspecialchars($_SESSION['fullname'] ?? 'User'); ?></span>
              <img src="<?php echo htmlspecialchars($nav_profile_pic); ?>" alt="profile" style="height: 55px; width: 55px; border-radius: 50%; object-fit: cover; border: 2px solid #667eea; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/>
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" style="position: absolute; right: 0; top: 100%; margin-top: 5px;">
              <a class="dropdown-item settings-panel-trigger" href="#" id="settingsTrigger">
